Oracle JDBC Driver patch release 19.17.0.0 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 19.17 release:

  - JDBC Thin Driver 19.17
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 19.17
    Client-side JDBC driver for use on a machine where OCI 19.17
    is installed.

  - JDBC Thin Server-side Driver 19.17
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 19.17
...
In order to use the JDBC Thin Driver 19.17, please add ojdbc8.jar or
